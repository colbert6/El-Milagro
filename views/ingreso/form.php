        ...
        <div class="row"  style="border-bottom: solid 1px #D8D8D8;margin: 0px 0px 0px 0px;">
            <div class="col-md-4">
                <div class="form-group"  style="margin: 5px auto 5px auto">
                    ...
                    <div class="col-md-6" style="width:60%;padding-right: 1px">
                        <input name="nrodoc" id="nrodoc" class="form-control"  onkeypress="return serieComprobante(event)" 
                               placeholder="Numero Documento" autofocus maxlength="18"  >
                    </div>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="form-group" style="margin: 5px auto 5px auto">
                    <label class="col-md-7 control-label" > Fecha Emision:</label>
                    <div class="col-md-5" style="width:63%">
                        <input name="fecha_emision" type="date" id="fecha_emision" class="form-control"  placeholder="Fecha" value="<?php echo $hoy; ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="form-group" style="margin: 5px auto 5px auto">
                    <label class="col-md-7 control-label" > Fecha Vencimiento:</label>
                    <div class="col-md-5" style="width:63%">
                        <input name="fecha_vencimiento" type="date" id="fecha_vencimiento" class="form-control"  placeholder="Fecha"  value="<?php echo $hoy; ?>">
                    </div>
                </div>
            </div>
        </div>
