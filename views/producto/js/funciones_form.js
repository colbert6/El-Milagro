$(function() {    
    ...
    $( "#save" ).click(function(){
         if( $("#codigo_barra").val()!='' && ($("#codigo_barra").val().length!=13 && $("#codigo_barra").val().length!=12 && $("#codigo_barra").val().length!=8 && $("#codigo_barra").val().length!=7&& $("#codigo_barra").val().length!=5)){
